...
cdef extern from "cuopt/linear_programming/constants.h": # noqa
    ...
    cdef const char* c_CUOPT_MIP_NODE_LIMIT "CUOPT_MIP_NODE_LIMIT" # noqa
    cdef const char* c_CUOPT_MIP_RELIABILITY_BRANCHING "CUOPT_MIP_RELIABILITY_BRANCHING" # noqa
...
CUOPT_MIP_NODE_LIMIT = c_CUOPT_MIP_NODE_LIMIT.decode('utf-8') # noqa
CUOPT_MIP_RELIABILITY_BRANCHING = c_CUOPT_MIP_RELIABILITY_BRANCHING.decode('utf-8') # noqa
